    ...
    <div className="page-wrapper" style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
        ...
        <div className="container" style={{ paddingTop: '150px', flexGrow: 1, zIndex: 10 }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: '40px', margin: '0 auto', paddingBottom: '80px' }}>
                ...
                {/* COLUMN 1: SOCIAL LINKS (COMPLETELY LEVELED) */}
                <div style={{ display: 'flex', flexDirection: 'column', gap: '15px' }}>
                    ...
                    {socials.map((s, i) => (
                        <a key={i} href={s.link} target="_blank" rel="noreferrer" style={{ textDecoration: 'none' }}>
                            ...
                            onMouseOut={(e) => { e.currentTarget.style.transform = 'none'; e.currentTarget.style.boxShadow = '4px 4px 0px rgba(0,0,0,0.1)'; e.currentTarget.style.borderColor = 'var(--text-primary)'; }}
                            >
                ...
                <div style={{ 
                    ...
                    <div style={{
                        ...
                        width: '80px', height: '30px', background: 'rgba(255, 255, 255, 0.6)', backdropFilter: 'blur(2px)',
